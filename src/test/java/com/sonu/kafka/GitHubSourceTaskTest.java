...
public class GitHubSourceTaskTest {
  ...
  public void test() throws UnirestException {
    ...
    HttpResponse<JsonNode> httpResponse = gitHubSourceTask.gitHubAPIHttpClient.getNextIssuesAPI(gitHubSourceTask.nextPageToVisit, gitHubSourceTask.nextQuerySince);
    if(httpResponse.getStatus() != 403) {
      assert (httpResponse.getStatus() == 200); // request is successful
